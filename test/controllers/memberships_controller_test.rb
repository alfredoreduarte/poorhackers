...
class MembershipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create membership" do
    assert_difference('Membership.count') do
      post memberships_url, params: { membership: { organization_id: @membership.organization_id, role: @membership.role, user_id: @membership.user_id } }
    end
  ...
  test "should update membership" do
    patch membership_url(@membership), params: { membership: { organization_id: @membership.organization_id, role: @membership.role, user_id: @membership.user_id } }
