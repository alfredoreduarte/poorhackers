...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { idea_id: @test.idea_id, result: @test.result, status: @test.status } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { idea_id: @test.idea_id, result: @test.result, status: @test.status } }
